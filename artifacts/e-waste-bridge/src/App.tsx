...
<div className="lot-row">
  ...
  <div>
    <div className="lot-name">{selected.description}</div>
    <div className="lot-desc">
      {selected.weightKg} kg · {selected.condition}
    </div>
  </div>
